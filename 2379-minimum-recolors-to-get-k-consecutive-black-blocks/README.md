...
🟢 **Easy** &nbsp;|&nbsp; [View on LeetCode](https://leetcode.com/problems/minimum-recolors-to-get-k-consecutive-black-blocks/)
...
**My Solution:** [2379-Minimum-Recolors-to-Get-K-Consecutive-Black-Blocks.cpp](./2379-Minimum-Recolors-to-Get-K-Consecutive-Black-Blocks.cpp)
